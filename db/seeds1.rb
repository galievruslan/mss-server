...
@route_template1.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[0][1]},{shipping_address: @shipping_addresses[1][1]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[1][2]}])
@route_template2 = TemplateRoute.create(manager: @manager1, day_of_week: 1)
@route_template2.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[1][2]}])
@route_template3 = TemplateRoute.create(manager: @manager1, day_of_week: 2)
@route_template3.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][2]}])
@route_template4 = TemplateRoute.create(manager: @manager1, day_of_week: 3)
@route_template4.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][2]}])
@route_template5 = TemplateRoute.create(manager: @manager1, day_of_week: 4)
@route_template5.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[2][1]},{shipping_address: @shipping_addresses[3][1]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][2]}])
@route_template6 = TemplateRoute.create(manager: @manager1, day_of_week: 5)
@route_template6.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[2][2]},{shipping_address: @shipping_addresses[3][2]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][2]}])
@route_template7 = TemplateRoute.create(manager: @manager1, day_of_week: 6)
@route_template7.template_route_points = TemplateRoutePoint.create([{shipping_address: @shipping_addresses[2][3]},{shipping_address: @shipping_addresses[3][3]},{shipping_address: @shipping_addresses[0][2]},{shipping_address: @shipping_addresses[1][2]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][3]},{shipping_address: @shipping_addresses[0][4]},{shipping_address: @shipping_addresses[1][4]},{shipping_address: @shipping_addresses[0][3]},{shipping_address: @shipping_addresses[1][2]}])
