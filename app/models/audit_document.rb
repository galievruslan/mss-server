class AuditDocument < ActiveRecord::Base
  attr_accessible :comment, :date, :manager_id, :percentage_shelves, :shipping_address_id, :manager, :shipping_address, :audit_document_item_ids, :audit_document_items_attributes, :guid
  belongs_to :manager
